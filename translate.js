document.addEventListener('DOMContentLoaded', function () {
    ...
    function switchLanguage(languageCode) {
        ...
        const translations = {
            'en': {
                'greeting': 'Hello, my name is Natalya, and I am a multidisciplinary designer with a diverse background. I began my career as a fashion designer after graduating from a prestigious fashion school in Milan. I had the privilege of working with renowned companies like Dolce & Gabbana and Marni, gaining invaluable experience in the industry. In 2018, with the onset of the pandemic, I transitioned into digital design. During the lockdown, I worked as a freelancer, creating labels, banners, logos, corporate styles, and web designs. This period sparked my passion for digital platforms and web development. This year, I completed my studies at DCI School as a web developer, acquiring solid skills in HTML, CSS, JavaScript, and React, along with foundational knowledge of backend technologies. I am now eager to contribute to a forward-thinking company where I can grow as a specialist in web development or web design. With over 10 years of experience as a designer, coupled with my newly acquired technical skills and sales background, I am confident in my ability to deliver unique and impactful solutions. My aim is to create websites and applications that stand out and truly resonate with users.',
                'design': "DESIGNER",
